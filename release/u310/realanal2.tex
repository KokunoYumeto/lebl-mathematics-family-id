...
\hypersetup{
    ...
    pdftitle={Analisis Dasar II: Pengantar Analisis Real, Jilid II},
...
\title{Analisis Dasar II: Pengantar Analisis Real, Jilid II}
...
% Partial-reader forward-reference numbers, frozen from the fully compiled
% v6.3 source.  The referenced content is outside this reader's admitted
% boundary; these definitions preserve the source's printed numbering without
% pretending that the omitted targets are present or clickable here.
\expandafter\gdef\csname r@exercise:CXCnormedspace\endcsname{{11.2.3}{}{}{}{}}
\expandafter\gdef\csname r@sec:arzelaascoli\endcsname{{11.6}{}{}{}{}}
\expandafter\gdef\csname r@sec:stoneweier\endcsname{{11.7}{}{}{}{}}
...
\flushright
{\Huge\bfseries \sffamily Analisis Dasar II }
\noindent\rule[-1ex]{\textwidth}{5pt}\\[2.5ex]
\hfill\emph{\Large \sffamily Pengantar Analisis Real, Jilid II}
\end{minipage}}
...
\noindent
Hak cipta \copyright 2012--2026 Ji{\v r}\'i Lebl
...
%
% not needed since the kdp version is does not include the cc licese
...
Karya ini
%PRINT
% not for lulu, not needed anymore, see above
...
kedua jilid menggunakan nomor versi yang sama.
