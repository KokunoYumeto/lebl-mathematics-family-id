...
\hypersetup{
    ...
    pdftitle={Analisis Dasar II: Pengantar Analisis Real, Jilid II — Cuplikan Kerja sampai Bukti Teorema 10.6.4 (2026-08-22)},
...
\today
\\
  (versi sumber 6.3)\\[1.5ex]
  \textbf{Cuplikan kerja Bahasa Indonesia — 22 Agustus 2026}\\
  Selesai berurutan sampai bukti Teorema 10.6.4 untuk domain tipe III;\\
  contoh medan vektor pusaran berikutnya belum disertakan.
