...
\hypersetup{
    ...
    pdftitle={Analisis Dasar: Pengantar Analisis Real},
...
\title{Analisis Dasar: Pengantar Analisis Real}
...
\flushright
{\Huge\bfseries \sffamily Analisis Dasar I }
\noindent\rule[-1ex]{\textwidth}{5pt}\\[2.5ex]
\hfill\emph{\Large \sffamily Pengantar Analisis Real, Jilid I}
\end{minipage}}
...
%\medskip
%\noindent
%Cover image: Mt. Olomana, Oahu, Hawaii, \copyright 2019 Ji{\v r}\'i Lebl, all rights reserved.
%
...
\noindent
Nomor versi atau edisi utama dinaikkan hanya jika terdapat perubahan yang
substansial. Sejak edisi keenam, kedua jilid menggunakan nomor versi yang sama.
Penomoran edisi dimulai dari 4, yaitu versi 4.0, karena sebelumnya nomor versi
tidak dicatat.  %The edition given with the ISBN number is the major version.
...
% This is the first volume only, these are for the two volume version
