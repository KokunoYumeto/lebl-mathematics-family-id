...
\begin{exercise}
Buktikan bahwa setiap lapangan terurut harus memuat suatu himpunan tak berhingga terhitung.
\end{exercise}
...
dipahami sebagai bukti konstruktif langsung bahwa setiap himpunan bagian tak berhingga terhitung
pasti tidak memuat setidaknya satu unsur.

\begin{proof}
Misalkan $X \subset \R$ suatu himpunan bagian
tak berhingga terhitung sedemikian sehingga untuk setiap pasangan bilangan real
...
Karena $X$ tak berhingga terhitung,
