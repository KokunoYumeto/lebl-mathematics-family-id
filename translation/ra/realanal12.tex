...
% Indonesian ij must remain two searchable Unicode characters, not Dutch U+0133.
...
% footnotes per page using symbols
\counterwithout{footnote}{chapter} % Fix footnotes starting at 2 on the first page of a chapter.
\usepackage{perpage}
\MakePerPage{footnote}
% On a clean first pass, perpage has not yet learned the page breaks and the
% counter can exceed the nine values supported by \fnsymbol.  Use a numeric
% fallback only for that bootstrap pass; later passes retain pagewise symbols.
\renewcommand{\thefootnote}{\ifnum\value{footnote}<10 \fnsymbol{footnote}\else\arabic{footnote}\fi}
...
\hypersetup{
    ...
    pdfkeywords={analisis real, integral Riemann, turunan, limit, barisan},
    pdfsubject={Analisis Real},
    pdftitle={Analisis Dasar I dan II: Pengantar Analisis Real},
    pdfauthor={Ji\v{r}\'i Lebl},
    pdflang={id-ID}
}
...
% Our graphics commands
\newcommand{\myincludegraphics}[3][]{\includegraphics[#1]{figures/#2}}
\newcommand{\myincludepdft}[2]{\subimport*{figures/}{#1.pdf_t}}
...
\title{Analisis Dasar I dan II: Pengantar Analisis Real}
...
%mbxdocinfo    </website>
%mbxdocinfo    <website>
%mbxdocinfo        <title>jirilebl.github.io/ra/</title>
%mbxdocinfo        <url>https://jirilebl.github.io/ra/</url>
%mbxdocinfo    </website>
%mbxdocinfo
...
%mbxdocinfo    <math-package latex-name="mathtools" mathjax-name="mathtools"/>
%mbxdocinfo
...
%mbx <title>Analisis Dasar I dan II</title>
%mbx <subtitle>Pengantar Analisis Real, Jilid I dan II</subtitle>
%mbx
%mbx <frontmatter>
%mbx   <bibinfo>
%mbx     <author>
...
%mbx     </author>
%mbx     <date><today /></date>
%mbx     <edition>Edisi ke-6, pembaruan 3 (versi 6.3)</edition>
%mbx     <website>
%mbx       <url href="https://www.jirka.org/ra/" visual="www.jirka.org/ra/" />
%mbx     </website>
%mbx     <website>
%mbx       <url href="https://jirilebl.github.io/ra/" visual="jirilebl.github.io/ra/" />
%mbx     </website>
%mbx     <copyright>
%mbx       <year>2009<ndash />2026</year>
...
%mbx       <shortlicense>
%mbx         Karya ini tersedia dengan dua pilihan lisensi: Lisensi Internasional Creative Commons Atribusi-Nonkomersial-BerbagiSerupa 4.0 dan
%mbx         Lisensi Internasional Creative Commons Atribusi-BerbagiSerupa 4.0. Untuk melihat salinan lisensi-lisensi tersebut, kunjungi
...
%mbx         atau kirim surat kepada Creative Commons PO Box 1866, Mountain View, CA 94042, USA.
%mbx         Anda boleh menggunakan, mencetak, menggandakan, dan membagikan buku ini sebanyak yang Anda inginkan.
%mbx         Anda boleh menjadikan buku ini sebagai dasar catatan Anda sendiri dan menggunakan kembali bagian-bagiannya selama lisensinya tetap sama.
%mbx         Anda boleh memilih CC BY-NC-SA atau CC BY-SA, sesuai dengan lisensi yang cocok untuk tujuan Anda.
%mbx         Karya turunan Anda wajib menggunakan setidaknya salah satu lisensi tersebut dan wajib ditandai secara jelas sebagai karya turunan.
%mbx         Edisi Bahasa Indonesia ini diterjemahkan dan disunting oleh OpenAI Codex gpt-5.6-sol, Ultra atas instruksi pengguna serta dilisensikan di bawah CC BY-SA 4.0.
%mbx         Edisi ini dibuat secara independen dan tidak didukung atau disahkan oleh penulis maupun penerbit karya sumber.
%mbx       </shortlicense>
%mbx     </copyright>
%mbx   </bibinfo>
%mbx
...
\flushright
{\Huge\bfseries \sffamily Analisis Dasar I \& II}
\noindent\rule[-1ex]{\textwidth}{5pt}\\[2.5ex]
\hfill\emph{\Large \sffamily Pengantar Analisis Real, Jilid I \& II}
\end{minipage}}
...
\flushright
{\bfseries 
oleh Ji{\v r}\'i Lebl\\[3ex]} 
\today
\\
(versi 6.3)
% --- 6th edition, 3rd update)
\end{minipage}}
...
\noindent
Ditata menggunakan \LaTeX.


\bigskip

\noindent
Hak cipta \copyright 2009--2026 Ji{\v r}\'i Lebl
...
\noindent
\myincludegraphics[width=1.38in]{license}{Logo lisensi CC BY-NC-SA}
\quad
\myincludegraphics[width=1.38in]{license2}{Logo lisensi CC BY-SA}
...
tersedia dengan dua pilihan lisensi:
Lisensi Internasional Creative Commons
Atribusi-Nonkomersial-BerbagiSerupa 4.0 dan
Lisensi Internasional Creative Commons
Atribusi-BerbagiSerupa 4.0.
Untuk melihat salinan lisensi-lisensi tersebut, kunjungi
...
\noindent
Anda boleh menggunakan, mencetak, menggandakan, dan membagikan buku ini
sebanyak yang Anda inginkan. Anda boleh menjadikan buku ini sebagai dasar
catatan Anda sendiri dan menggunakan kembali bagian-bagiannya selama lisensinya
tetap sama. Anda boleh memilih CC BY-NC-SA atau CC BY-SA, sesuai dengan lisensi
yang cocok untuk tujuan Anda. Karya turunan Anda wajib menggunakan setidaknya
salah satu lisensi tersebut. Karya turunan wajib ditandai secara jelas sebagai
karya turunan.

\bigskip

\noindent
Edisi Bahasa Indonesia ini merupakan karya turunan yang diterjemahkan dan
disunting oleh OpenAI Codex gpt-5.6-sol, Ultra atas instruksi pengguna. Edisi ini dilisensikan di bawah
Lisensi Internasional Creative Commons Atribusi-BerbagiSerupa 4.0 (CC BY-SA
4.0). Edisi ini dibuat secara independen dan tidak didukung atau disahkan oleh
penulis maupun penerbit karya sumber.

\bigskip

\noindent
Selama penulisan buku ini, penulis mendapat dukungan sebagian dari hibah NSF
DMS-0900885 dan DMS-1362337.

\bigskip

\noindent
Tanggal merupakan pengenal utama suatu versi. Nomor versi atau edisi utama
dinaikkan hanya jika terdapat perubahan yang substansial. Sejak edisi keenam,
kedua jilid menggunakan nomor versi yang sama. Penomoran edisi dimulai dari 4
untuk Jilid I, yaitu versi 4.0, karena sebelumnya nomor versi tidak dicatat.
%The edition given with the ISBN number is the major version.

\bigskip

\noindent
Lihat \url{https://www.jirka.org/ra/} atau \url{https://jirilebl.github.io/ra/}
untuk informasi lebih lanjut (termasuk informasi kontak, kemungkinan
pembaruan, dan daftar ralat).

\bigskip

\noindent
Sumber \LaTeX\ buku ini tersedia untuk kemungkinan modifikasi dan penyesuaian
di GitHub: \url{https://github.com/jirilebl/ra}
...
\subsection{Tentang Jilid I}
}

\newcommand{\VolTwoIntro}{
\subsection{Tentang Jilid II}
...
\cleardoublepage  
\phantomsection
\addcontentsline{toc}{chapter}{Bacaan Lanjutan}
\markboth{BACAAN LANJUTAN}{BACAAN LANJUTAN}
\begin{bibchapter}[Bacaan Lanjutan]
\begin{biblist}[\normalsize]
...
\bib{GIAM}{misc}{
   ...
   note={Tersedia di \url{http://giam.southernct.edu/GIAM/}},
}

\bib{Hammack}{misc}{
   author={Hammack, Richard},
   title={Book of Proof},
   note={Tersedia di \url{https://richardhammack.github.io/BookOfProof/}},
}

\bib{Rosenlicht}{book}{
   author={Rosenlicht, Maxwell},
   title={Introduction to Analysis},
   note={Cetak ulang edisi 1968},
...
%mbx   <title>Bacaan Lanjutan</title>
%mbx
%mbx   <biblio type="raw" xml:id="biblio-BS" tag="BS">Robert G. Bartle dan Donald R. Sherbert,
%mbx     <title>Introduction to Real Analysis</title>,
%mbx     edisi ke-3, John Wiley &amp; Sons Inc., New York, 2000.</biblio>
%mbx
%mbx   <biblio type="raw" xml:id="biblio-DW" tag="DW">John P. D'Angelo dan Douglas B. West,
%mbx     <title>Mathematical Thinking: Problem-Solving and Proofs</title>,
%mbx     edisi ke-2, Prentice Hall, 1999.</biblio>
%mbx
...
%mbx     Tersedia di <url href="http://giam.southernct.edu/GIAM/" />.</biblio>
%mbx
...
\renewenvironment{theglossary}%
  {\setlength\cellspacetoplimit{4pt}
   ...
   \begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.19\textwidth}@{\hspace{0.025\textwidth}}>{\raggedright\arraybackslash}p{0.61\textwidth}@{\hspace{0.025\textwidth}}>{\raggedleft\arraybackslash}p{0.12\textwidth}@{}}}%
  {\end{longtable}}%
\cleardoublepage
\microtypesetup{protrusion=false}
