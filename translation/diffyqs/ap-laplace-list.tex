\chapter{Tabel Transformasi Laplace} \label{laplacelist:appendix}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Fungsi $u$ adalah fungsi
Heaviside, $\delta$ adalah fungsi delta Dirac, dan 
\begin{equation*}
\Gamma(t) =
