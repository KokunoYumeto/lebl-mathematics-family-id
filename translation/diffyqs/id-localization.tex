...
% varioref page-position phrases used by \myvref.  varioref reapplies its
% American strings at \begin{document}, so apply the Indonesian overlay both
% now and at the end of the begin-document hook.
