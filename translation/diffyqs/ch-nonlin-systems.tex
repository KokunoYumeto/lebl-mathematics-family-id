...
Nilai eigennya real ketika $\cos \theta < 0$. Hal ini terjadi pada
...
Nilainya tidak bergantung pada sudut awal $\theta_0$. Periode sebenarnya $T$
...
\begin{tasks}
\task
Tentukan rumus $\omega$ yang memberikan lintasan dengan kondisi
...
mungkin dilakukan.  Inilah salah satu sumber utama kesulitannya, sebab
...
cuaca dengan akurat.  Lagi pula, kita sebenarnya tidak mengetahui kondisi
